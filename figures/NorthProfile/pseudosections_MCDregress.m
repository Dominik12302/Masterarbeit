...
%% export figures
export_fig(h1,'pseudo_phaseXY_MCDregress.png','-painters','-r300','-p0.01')
export_fig(h2,'pseudo_phaseYX_MCDregress.png','-painters','-r300','-p0.01')
export_fig(h3,'pseudo_rhoXY_MCDregress.png','-painters','-r300','-p0.01')
export_fig(h4,'pseudo_rhoYX_MCDregress.png','-painters','-r300','-p0.01')
