...
ylimit = [1 1E3];
ylabelcorr = [4.6 0 0];
width = [0 0 200 0]; % substracted from position
col = {'r','b','m','g'};


openfig('2000L_MCDregress_coh08.fig')
...
set(yhandle,'position',get(yhandle,'position') + ylabelcorr - [0 120 0]);
set(get(plotaxes(2),'Title'),'String','2000L - MCD regression')
...
export_fig('2000L_MCDregress_coh08.png','-painters','-r300','-p0.01')

%% For 7205B

openfig('2000L_Mestimate_coh08.fig')
set(gcf,'renderer','painter','Color','w','Position',get(gcf,'Position')-width);
plotaxes = get(gcf,'children');
...
yhandle = get(plotaxes(2),'Ylabel');
set(yhandle,'position',get(yhandle,'position') + ylabelcorr - [0 120 0]);
set(get(plotaxes(2),'Title'),'String','2000L - M-estimator')
...
export_fig('2000L_Mestimate_coh08.png','-painters','-r300','-p0.01')
...
openfig('2000L_Mestimate_coh08_RR2400L.fig')
set(gcf,'renderer','painter','Color','w','Position',get(gcf,'Position')-width);
plotaxes = get(gcf,'children');
...
yhandle = get(plotaxes(2),'Ylabel');
set(yhandle,'position',get(yhandle,'position') + ylabelcorr - [0 120 0]);
set(get(plotaxes(2),'Title'),'String','2000L-rr2400L - M-estimator')
...
export_fig('2000L_Mestimate_coh08_RR2400L.png','-painters','-r300','-p0.01')