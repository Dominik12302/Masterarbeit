...
% CODE4- TO BE removed 
if strfind(header.sens_name,'MFS11'), header.lsb = header.lsb / 134.4;  end
if strfind(header.sens_name,'MFS10'), header.lsb = header.lsb / 800;  end
...
if strfind(header.sens_name,'Geomag'), header.lsb = header.lsb / 0.75;  end
