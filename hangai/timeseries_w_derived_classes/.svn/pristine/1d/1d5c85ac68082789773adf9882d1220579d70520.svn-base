...
proc.output     = {'Ex' 'Ey'};
proc.bandsetup  = 'MT';
proc            = EMProc(proc,{'E15' 'E24' 'E25'});
proc.lsrate     = 512;
proc.bsrate     = 512;
proc.bsname     = {'E15'};
proc.lsname     = {'E25'};
proc.usetime    = [];                 % leave empty: use all avaible data
procdef.avrange = [10 2];             % averaging domain Nfc x Nsets for smoothing of spectral matrics; this imparts on the coherency estimation, polarization props. etc.
procdef.bicohthresg = {[0.9 1]};      % threshold fcs for which the coherency is estimated below 0.9    
