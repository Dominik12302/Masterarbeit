...
% Last Modified by GUIDE v2.5 18-Jun-2016 13:25:18
...
%Create tab group
handles.tgroup = uitabgroup('Parent', handles.EMTimeSeriesGUI,'TabLocation', 'top','Visible','off');
handles.tab1 = uitab('Parent', handles.tgroup, 'Title', 'Import');
handles.tab2 = uitab('Parent', handles.tgroup, 'Title', 'Site Info');
handles.tab3 = uitab('Parent', handles.tgroup, 'Title', 'Runtimes');
handles.tab4 = uitab('Parent', handles.tgroup, 'Title', 'Time series');
handles.tab5 = uitab('Parent', handles.tgroup, 'Title', 'Convert');

%Place panels into each tab
set(handles.panel_import,'Parent',handles.tab1)
set(handles.panel_textinfo,'Parent',handles.tab2)
set(handles.panel_runtimes,'Parent',handles.tab3)
set(handles.panel_ts,'Parent',handles.tab4)
set(handles.panel_edit_convert,'Parent',handles.tab5)
%Reposition each panel to same location as panel 1
set(handles.panel_textinfo,'position',get(handles.panel_import,'position'));
set(handles.panel_runtimes,'position',get(handles.panel_import,'position'));
set(handles.panel_edit_convert,'position',get(handles.panel_import,'position'));
set(handles.panel_ts,'position',get(handles.panel_import,'position'));
...
if get(handles.import_ts,'Value')
    ...
    set(handles.export_proc_filter,'Enable','on');
else
    set(handles.import_adc_filter,'Enable','off');
    set(handles.export_proc_filter,'Enable','off');
end
function import_fc_Callback(hObject, eventdata, handles)
function import_ts_adc_Callback(hObject, eventdata, handles)
function import_ts_proc_Callback(hObject, eventdata, handles)
...
function export_proc_filter_Callback(hObject, eventdata, handles)
function export_proc_filter_CreateFcn(hObject, eventdata, handles)
...
if get(handles.import_ts_adc,'Value')
    pt = textscan(get(handles.import_adc_filter,'String'),'%s');
elseif get(handles.import_ts_proc,'Value')
    pt = textscan(get(handles.import_proc_filter,'String'),'%s');
end
%set(handles.panel_statusbar,'Backgroundcolor',[1 0 0 ]);
%pause(0.1)
handles.emts.datapath = pt{1}';
...
plot(handles.emts,'time','utc','units','mV','color','k','axes',ax(1:Nch),'newplot',1);
...
snames  = snames(val)';
srates =  get(handles.conv_srate,'String');
val     = get(handles.conv_srate,'Value');
srates = str2num(srates(val,:));

handles.emts.resmpfreq = str2num(get(handles.ts_resmpfreq,'String'));
usech = textscan(get(handles.conv_usech,'String'),'%s');
handles.emts.usech  = usech{1}';
usetime = {[]};
